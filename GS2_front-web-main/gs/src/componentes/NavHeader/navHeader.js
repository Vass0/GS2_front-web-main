...
const ButtonSair = styled.button`
    ...
    &:hover{
        background-color:#e7ce7f;
        color:white;
    }
`

const navOptions = ['Home', 'Diabetes', 'Contato', 'Projeto', 'Login']
...
function NavHeader(){
    ...
    return(
        ...
        <TitleUl>
            ...
            <CursorP><StyledLink to="/Home"><Logo/></StyledLink></CursorP>
        </TitleUl>
        <OpcoesUl className='opcoes' list-style="none">
            ...
            <Opcoesli display="inline-block"><CursorP><StyledLink to="/Diabetes">Diabetes</StyledLink></CursorP></Opcoesli>
            <Opcoesli display="inline-block"><CursorP><StyledLink to="/Contato">Contato</StyledLink></CursorP></Opcoesli>
            <Opcoesli display="inline-block"><CursorP><StyledLink to="/Foco">Projeto</StyledLink></CursorP></Opcoesli>
            ...
            <DropDownBotao display="inline-block">
                <Dropdown>
                    ...
                    <Dropdown.Menu>
                        ...
                        <Dropdown.Item><StyledLink to="/TDAH"><BotoesDropDown>Diabetes</BotoesDropDown></StyledLink></Dropdown.Item>
                        <Dropdown.Item><StyledLink to="/Contato"><BotoesDropDown>Contato</BotoesDropDown></StyledLink></Dropdown.Item>
                        <Dropdown.Item><StyledLink to="/Foco"><BotoesDropDown> Projeto</BotoesDropDown></StyledLink></Dropdown.Item>
